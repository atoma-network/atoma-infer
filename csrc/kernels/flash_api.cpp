...
extern "C" void mha_fwd(
    const void *q,       // batch_size x seqlen_q x num_heads x head_size
    const void *k,       // batch_size x seqlen_k x num_heads_k x head_size
    const void *v,       // batch_size x seqlen_k x num_heads_k x head_size
