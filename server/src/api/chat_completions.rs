...
// TODO: This will be a bit tricky since some of the Message types
// will require specific values to be available. We can make some concrete
// Message types under an enum that require those types, but for parsing
// the json we need to be slightly more relaxed. The error can still be
// propagated to the user if conversion to a concrete type fails.
#[derive(Debug, Serialize, Deserialize, JsonSchema)]
